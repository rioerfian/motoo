    ...
    <>
      <div className="relative md:ml-64 bg-gray-200 p-6 shadow-xl">
        <div className="px-8 py-4 bg-white">
          ...
          <FaPlus className="text-xl"/>&emsp;
          <h2 className="text-xl py-3 font-bold">
            Create Products / Application
          </h2>
          </div>
          ...
          <form className="mt-4">
            ...
            <div className="flex items-center justify-end">
              <Link
                type="submit"
                className=" bg-red-500 text-white font-medium rounded-lg text-sm flex items-center py-2 px-4 my-2 mr-2"
              >
                <FaEdit />
                &nbsp;Submit
              </Link>
